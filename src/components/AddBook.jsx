                ...
                <div className="form">
                    <form action="" onSubmit={handleSubmit} >
                        ...
                        <div className="shortDescription" >
                            <textarea name="" id="" cols="52" rows="7" placeholder="short Description for the title" value={shortDescription} onChange={(e) => setShort(e.target.value)}></textarea>
                        </div>
                        <div className="longDescription" >
                            <textarea name="" id="" cols="52" rows="7" placeholder="long Description for the title" value={longDescription} onChange={(e) => setLong(e.target.value)} ></textarea>
                        </div>
